...
class VideoLeadScanner:
    ...
    async def create_scene_based_video(
        ...
        fusion_plan = self._create_fusion_strategy(scene_videos, target_duration)
    ...
    def _create_fusion_strategy(
        self, scene_videos: Dict[str, List[VideoLead]], target_duration: int
    ) -> Dict[str, Any]:
                ...
                fusion_segments.append(
                    {
                        ...
                        "transition": "fade" if total_duration > 0 else "none",
                    }
                )
    ...
    async def _analyze_video_patterns(self, leads: List[VideoLead]) -> Dict[str, Any]:
