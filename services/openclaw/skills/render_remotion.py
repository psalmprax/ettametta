...
class RemotionRenderSkill:
    ...
    def __init__(self, remotion_project_path: str = "/home/psalmprax/ALL_PROJECTS/viral_forge/services/video_engine/remotion_app"):
        self.project_path = remotion_project_path
        
    def render_remotion_clip(self, composition: str, props: Dict[str, Any], output_name: str = "remotion_output.mp4") -> str:
        """
        ...
        try:
            ...
            result = subprocess.run(cmd, cwd=self.project_path, check=True, capture_output=True, text=True)
