# Graph Report - ettametta  (2026-05-27)

## Corpus Check
- 1053 files · ~861,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 17725 nodes · 29503 edges · 1595 communities (1087 shown, 508 thin omitted)
- Extraction: 67% EXTRACTED · 33% INFERRED · 0% AMBIGUOUS · INFERRED: 9624 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa47ca5f`
...
- `warmup()` --calls--> `Pipeline`  [INFERRED]
  src/engines/remote_ai_setup/warmup_models.py → graphify/ARCHITECTURE.md

## Communities (1595 total, 508 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (201): PatternDeconstructor, Calls Groq API to deconstruct the video into hooks and sentiment., Calls Groq API to deconstruct the video into hooks and sentiment., ContentCandidate, Unified content candidate model covering both discovery and search results., Unified content candidate model covering both discovery and search results., ViralPattern, DiscoveryScannerBase (+193 more)
...
Cohesion: 0.01
Nodes (203): delete_account(), list_accounts(), Account management routes — list and unlink social accounts.  Extracted from the, auth_instagram(), auth_instagram_callback(), auth_linkedin(), auth_linkedin_callback(), auth_snapchat() (+195 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (188): CircuitBreaker, Fetch YouTube analytics data, Simple circuit breaker to prevent cascading failures, Fetch analytics from social media platforms, Fetch metrics from specific social platform, Get Instagram post metrics, Get TikTok video metrics, Get X/Twitter metrics (+180 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (187): Stops the autonomous loop., Loads state from DB and resumes if was running., A single iteration of the autonomous cycle., The Autonomous Director of ettametta.     Orchestrates Discovery, Analysis, Prod, Uses LLM to decide on video title, hooks, and product alignment., Starts the autonomous production loop., Receives frontend error reports from GlobalErrorBoundary., Adds artificial delay to a service. (+179 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (161): BaseModel, download_video(), GenerationRequest, PersonaRequest, Serve the completed file back to the main Ettametta server, Serve the completed file back to the main Ettametta server, Config, get_me() (+153 more)
...
Cohesion: 0.17
Nodes (117): AffiliateService, Any affiliate API integration.      Disabled by default - set ENABLE_AFFILIATE_A, Any affiliate API integration.      Disabled by default - set ENABLE_AFFILIATE_A, Any affiliate API integration.      Disabled by default - set ENABLE_AFFILIATE_A, ContentPerformance, AnalyticsService, StoryScene, StoryScript (+109 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (126): get_payment_service(), cancel_subscription(), create_checkout_session(), CreateCheckoutRequest, get_subscription(), Billing API Routes for ettametta, Cancel current subscription, Cancel current subscription (+118 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (70): account_audit(), Performs an autonomous audit of a social media account., Performs an autonomous audit of a social media account., Performs an autonomous audit of a social media account., AuditSkill, Get user's OAuth token for specified platform., Get user's OAuth token for specified platform., Fetch account data for any platform. (+62 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (57): CloakFacebookScanner, Cloak-Backed Facebook Scanner  Uses CloakBrowser stealth engine as primary scrap, Facebook scanner backed by CloakBrowser stealth engine with httpx fallback., CloakInstagramScanner, Cloak-Backed Instagram Scanner  Uses CloakBrowser stealth engine as primary scra, Instagram scanner backed by CloakBrowser stealth engine with httpx fallback., Cloak-Backed LinkedIn Scanner  Uses CloakBrowser stealth engine as primary scrap, CloakBrowser Scanner — Multi-Platform Stealth Scraping Engine  A DiscoveryScanne (+49 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (60): OpenClawBaseSkill, Standardized authorization headers for internal OpenClaw routing., Standardized authorization headers for internal OpenClaw routing., Base class for all ettametta Official Skills.     Enforces the mission-based pat, Polymorphic entry point for OpenClaw agent., Triggers a new video transformation or generation job based on the action., DataScrapingSkill, Executes the Data Scraping mission. (+52 more)
...
Cohesion: 0.03
Nodes (87): AutoCreator, Autonomous Video Creation Engine.     Hardened with Circuit Breakers and retries, Autonomous Video Creation Engine.     Hardened with Circuit Breakers and retries, Autonomous Video Creation Engine.     Hardened with Circuit Breakers and retries, Approve or reject a pending DAG for PARTIAL mode.          Called by REST routes, Approve or reject a pending DAG for PARTIAL mode.          Called by REST routes, Approve or reject a pending DAG for PARTIAL mode.          Called by REST routes, Get the pending DAG preview for a job (for API polling). (+79 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (90): extract_c(), extract_cpp(), extract_csharp(), extract_java(), extract_kotlin(), extract_php(), extract_ruby(), extract_scala() (+82 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (85): analyze_content_type(), check_content_freshness(), check_eligibility(), curl_youtube(), discover_multi_platform(), expand_query_intelligently(), main(), Search YouTube by nearest date - prioritize newest content (+77 more)

### Community 16 - "Community 16"
Cohesion: 0.04
Nodes (57): DefaultCognitionHandler, DefaultEgressHandler, DefaultIngressHandler, DefaultSynthesisHandler, NodeHandler, NodeHandlerRegistry, TopicFusionCognitionHandler, TopicFusionSynthesisHandler (+49 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (61): BaseNode, Parallel asset sourcing using the DAG video compiler.         Each segment gets, Parallel asset sourcing using the DAG video compiler.         Each segment gets, Parallel asset sourcing using the DAG video compiler.         Each segment gets, Protocol, _CachingNode, main(), Simple test node that records its execution order. (+53 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (66): NexusOrchestrator, Primary vibe check using Dify, with LangChain fallback., Query Dify provider for video vibe data., Query LangChain provider for video vibe data., Get the number of frames in a video clip., Primary vibe check using Dify, with LangChain fallback., Get the number of frames in a video clip., Extract a middle frame from the video clip for audit. (+58 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (61): [actionLogs, setActionLogs], [activeEngine, setActiveEngine], { agents, logs: systemLogs, status, pulse }, [currentStep, setCurrentStep], displayLogs, engine, fetchData, handleToggle() (+53 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (67): [activeEngine, setActiveEngine], [adminAudits, setAdminAudits], { agents, logs: systemLogs, status, pulse }, fetchData, fetchSecurityEvents(), fetchSecurityStatus(), fetchSettings(), [isLoading, setIsLoading] (+59 more)

### Community 21 - "Community 21"
Cohesion: 0.05
Nodes (68): ClawHubSearchRequest, crewai_status(), CrewRequest, execute_code(), generate_seo_content(), get_popular_skills(), get_skill_categories(), get_social_metrics() (+60 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (51): DriftDetector, 10/10 Proof: The Algorithm Shift Sentry.     Detects when the platform algorithm, 10/10 Proof: The Algorithm Shift Sentry.     Detects when the platform algorithm, Standard: Stateful Recovery.         Loads the last 50 deltas from the database, Standard: Stateful Recovery.         Loads the last 50 deltas from the database, Records the delta for a single production cycle.         Persists to Postgres fo, Records the delta for a single production cycle.         Persists to Postgres fo, Returns True if the algorithm shift requires a system-wide recalibration. (+43 more)
...
Cohesion: 0.03
Nodes (34): Test Analytics Service, Test Analytics circuit breaker, Test retention dropoff detection, Test monetization suggestions, Test monetization orchestrator failover logic, Test empire service metrics, Test security sentinel system audit, Test voiceover service engines (+26 more)

### Community 26 - "Community 26"
Cohesion: 0.04
Nodes (51): DashboardPageLayoutProps, Tab, [isMobile, setIsMobile], [mobileMenuOpen, setMobileMenuOpen], [sidebarCollapsed, setSidebarCollapsed], { user, credits }, currentEngine, intelligenceItems (+43 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (53): _dag_notify(), ParallelAssetSourceNode, DAG node: Search and rank stock footage by CLIP semantic similarity.      This i, DAG node: Search and rank stock footage by CLIP semantic similarity.      This i, Run multiple asset sourcing strategies in parallel and return the first success., Run multiple asset sourcing strategies in parallel and return the first success., Publish a progress update for a DAG node via WebSocket.      Non-blocking: failu, Publish a progress update for a DAG node via WebSocket.      Non-blocking: failu (+45 more)

### Community 28 - "Community 28"
Cohesion: 0.04
Nodes (49): acquire_slot(), check_module_available(), CircuitBreaker, GpuQueueManager, ModelManager, Download model from HuggingFace Hub., Refines a simple user prompt into a high-fidelity director's prompt tailored for, Refines a simple user prompt into a high-fidelity director's prompt tailored for (+41 more)

### Community 29 - "Community 29"
Cohesion: 0.06
Nodes (61): _csharp_extra_walk(), extract_blade(), extract_dart(), extract_elixir(), _extract_generic(), extract_lua(), extract_powershell(), _extract_python_rationale() (+53 more)
...
Cohesion: 0.04
Nodes (36): OpenClawBaseSkill, BrowserSkill, Polymorphic entry point for OpenClaw agent., Polymorphic entry point for OpenClaw agent., Browser Skill for OpenClaw agents.     Retrieves raw HTML content from target UR, Browser Skill for OpenClaw agents.     Retrieves raw HTML content from target UR, ChatSalesSkill, Executes the Chat Sales mission. (+28 more)
...
Cohesion: 0.04
Nodes (50): [actionLogs, setActionLogs], [activeBlueprint, setActiveBlueprint], [activeCategory, setActiveCategory], [activeEngine, setActiveEngine], [activeJobId, setActiveJobId], activePipelineJob, [activeSwapDrawerIndex, setActiveSwapDrawerIndex], { agents, logs: systemLogs, lastJobUpdate, pulse, status } (+42 more)
...
Cohesion: 0.06
Nodes (47): Run migrations in 'offline' mode.      This configures the context with just a U, Run migrations in 'offline' mode.      This configures the context with just a U, Run migrations in 'online' mode.      In this scenario we need to create an Engi, Run migrations in 'online' mode.      In this scenario we need to create an Engi, run_migrations_offline(), run_migrations_online(), CreditService, Get user's credit transaction history (+39 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (45): cluster(), Run Leiden community detection. Returns {community_id: [node_ids]}.      Communi, _cypher_escape(), _html_script(), _html_styles(), _hyperedge_script(), prune_dangling_edges(), Remove edges whose source or target node is not in the node set.      Returns th (+37 more)
...
Cohesion: 0.06
Nodes (52): gemini_install(), _install_gemini_hook(), Copy skill file to ~/.gemini/skills/graphify/, write GEMINI.md section, and inst, _agents_install(), _agents_uninstall(), _install(), Tests for graphify install --platform routing., Claude platform install writes CLAUDE.md; others do not. (+44 more)

### Community 42 - "Community 42"
Cohesion: 0.05
Nodes (34): CircuitBreaker, _is_valid_key(), Inner implementation of chat, wrapped by the global timeout in chat()., Unified chat interface with complexity-based routing and failure persistence., Unified chat interface with complexity-based routing and failure persistence., Inner implementation of chat, wrapped by the global timeout in chat()., Inner implementation of chat, wrapped by the global timeout in chat()., Standard 1.14: Circuit Breaker with Exponential Backoff (+26 more)
...
Cohesion: 0.05
Nodes (47): [actionLogs, setActionLogs], [activeTab, setActiveTab], { agents, logs: systemLogs, status, pulse }, [auditReports, setAuditReports], [biasReport, setBiasReport], handleRunAccountAudit(), handleRunBiasScan(), handleRunSecurityAudit() (+39 more)

### Community 45 - "Community 45"
Cohesion: 0.05
Nodes (31): Alternative: Edit using MoviePy (more Pythonic, better for text overlays), Alternative: Edit using MoviePy (more Pythonic, better for text overlays), ColorClip, CompositeVideoClip, MockMoviePy, Test the complete video production pipeline, Test the complete video production pipeline, test_production_pipeline() (+23 more)

### Community 46 - "Community 46"
Cohesion: 0.05
Nodes (27): PlaywrightVideoSkill, HaiperSkill, Haiper AI browser automation skill - Tier 1 easiest target     Clean UI, no logi, Haiper AI browser automation skill - Tier 1 easiest target     Clean UI, no logi, Polymorphic entry point for OpenClaw agent., Generate video from prompt using Haiper AI, LeiaPixSkill, LeiaPix browser automation skill - Image to video conversion     VERY easy autom (+19 more)
...
Cohesion: 0.04
Nodes (35): generative_service(), Unit tests for GenerativeService - Video synthesis service. Tests circuit breake, Create a GenerativeService instance with mocked dependencies., Create a GenerativeService instance with mocked dependencies., Test video synthesis functionality., Test video synthesis functionality., Test health reporting functionality., Test health reporting functionality. (+27 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (43): auth_headers(), auth_token(), client(), create_mock_module(), mock_groq(), mock_redis(), mock_redis_async(), MockModule (+35 more)
...
Cohesion: 0.05
Nodes (41): dag_execute_blueprint(), execute_blueprint(), _execute_cognition_node(), _execute_custom_node(), _execute_egress_node(), _execute_ingress_node(), get_blueprint_by_id(), get_blueprints() (+33 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (32): main(), Update the Prometheus circuit breaker state gauge., Update the Prometheus circuit breaker state gauge., Record success on circuit breaker and atomically sync Prometheus gauge., Record success on circuit breaker and atomically sync Prometheus gauge., Bridges Python logic to the Remotion React studio for programmatic video renderi, Record failure on circuit breaker and atomically sync Prometheus gauge., Record failure on circuit breaker and atomically sync Prometheus gauge. (+24 more)
...
Cohesion: 0.06
Nodes (23): containerVariants, itemVariants, LandingPage(), CallbackHandler(), AuthContext, AuthContextType, TokenManager, useAuth() (+15 more)
...
Cohesion: 0.05
Nodes (24): AffiliateTool, Recommends high-converting products/links based on video script., Registers a new affiliate link in the database., Standardized Tool for Agent Zero to manage affiliate links and monetization., DiscoveryTool, Searches for trending niches across multi-platform scanners., Standardized Tool for Agent Zero to access the ettametta Discovery Engine., MarketScreenerTool (+16 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (42): collect_files(), extract_python(), Extract classes, functions, and imports from a .py file via tree-sitter AST., Call-graph pass must produce INFERRED calls edges., AST-resolved call edges are deterministic and should be EXTRACTED/1.0., Same input always produces same output., run_analysis() calls compute_score() - must appear as a calls edge., Analyzer.process() calls run_analysis() - cross class→function calls edge. (+34 more)

### Community 69 - "Community 69"
Cohesion: 0.09
Nodes (26): BaseMonetizationStrategy, Executes a strategy method with automatic failover if the primary strategy fails, _call_groq(), CircuitBreaker, OptimizationService, Uses shared AIWorker to generate SEO-optimized title, description, and hashtags., Simple circuit breaker to prevent cascading failures, Complete SEO optimization using AI for viral content.         Returns optimized (+18 more)

### Community 70 - "Community 70"
Cohesion: 0.07
Nodes (29): RequestLoggingMiddleware, SecurityHeadersMiddleware, TracingMiddleware, InternalJobClient, Helper to try primary then fallback URL, Helper to try primary then fallback URL, Client for internal services to communicate with the API.     Used for database, Client for internal services to communicate with the API.     Used for database (+21 more)

### Community 71 - "Community 71"
Cohesion: 0.06
Nodes (40): ABTestCreate, ABTestVariantEvent, calculate_statistics(), delete_test(), determine_winner(), get_active_tests(), get_completed_tests(), get_test_results() (+32 more)
...
Cohesion: 0.06
Nodes (29): client(), generate_viral_script(), Source real stock video or synthesize with engine., Main creation loop protected by CircuitBreaker.                  Args:, Main creation loop protected by CircuitBreaker.                  Args:, Main creation loop protected by CircuitBreaker.                  Args:, Generate real TTS with provider fallback., Generate real TTS with provider fallback. (+21 more)
...
Cohesion: 0.05
Nodes (35): [actionLogs, setActionLogs], [activeEngine, setActiveEngine], [activeStack, setActiveStack], [activityFeed, setActivityFeed], { agents, logs: systemLogs, status, pulse }, [audioUrl, setAudioUrl], displayLogs, [duration, setDuration] (+27 more)

### Community 77 - "Community 77"
Cohesion: 0.13
Nodes (20): ConnectError, An error occurred at the transport layer., Failed to establish a connection., TimeoutException, TransportError, Request, AsyncBaseTransport, BaseTransport (+12 more)
...
Cohesion: 0.06
Nodes (31): PaymentService, Get subscription details from Stripe, Cancel a subscription at period end, Handle Stripe webhook events, Stripe payment integration for subscriptions, Create a Stripe customer for a user, Create a checkout session for subscription, Verify Stripe customer creation helper. (+23 more)

### Community 81 - "Community 81"
Cohesion: 0.05
Nodes (30): Test premium video generation with pro workflow, Test premium video generation with pro workflow, Test subscription management, Test performance analytics, Test trending content discovery, Test A/B test creation, Test trending content discovery, Test content scheduling (+22 more)

### Community 82 - "Community 82"
Cohesion: 0.09
Nodes (37): build_from_json(), Build a NetworkX graph from an extraction dict.      directed=True produces a Di, attach_hyperedges(), Store hyperedges in the graph's metadata dict., _strip_diacritics(), to_json(), load_extraction(), Legacy 'source' key on nodes is renamed to 'source_file' before graph build. (+29 more)
...
Cohesion: 0.07
Nodes (37): check_and_post_scheduled(), _check_and_post_scheduled_internal(), cleanup_old_scheduled(), _cleanup_old_scheduled_internal(), cleanup_pending_videos(), _cleanup_pending_videos_internal(), _get_publisher(), Periodic task wrapper to check for scheduled posts.     Runs internal async logi (+29 more)

### Community 87 - "Community 87"
Cohesion: 0.08
Nodes (37): _agents_install(), _agents_uninstall(), _antigravity_install(), _antigravity_uninstall(), _check_skill_version(), _clone_repo(), gemini_uninstall(), install() (+29 more)
...
Cohesion: 0.06
Nodes (20): BaseMonetizationStrategy, CircuitBreaker, Stateful circuit breaker to track strategy health., Get commerce/affiliate products for the given niche.         In production, this, Generate a call-to-action for commerce products.         In production, this sho, CourseStrategy, Fetches course platform URL from database configuration., Generates a call to action for course sales. (+12 more)

### Community 92 - "Community 92"
Cohesion: 0.06
Nodes (24): [envData, setEnvData], EnvKey, fetchEnvKeys(), filteredKeys, handleFileUpload(), handleRestart(), [isLoading, setIsLoading], [isRestarting, setIsRestarting] (+16 more)
...
Cohesion: 0.07
Nodes (28): circuit_breaker(), CircuitBreaker, CircuitBreakerConfig, CircuitBreakerOpenError, CircuitState, get_all_breakers_status(), get_circuit_breaker(), Circuit Breaker Pattern Implementation for External API Resilience  Provides cir (+20 more)

### Community 98 - "Community 98"
Cohesion: 0.11
Nodes (25): AutoMerchService, Handles 'Reverse Monetization':     1. Trend -> Image Design Prompt (VLM)     2., Handles 'Reverse Monetization':     1. Trend -> Image Design Prompt (VLM)     2., CryptoStrategy, Crypto/Donations strategy - Accept crypto tips or donations, Extract wallet address for a given symbol, Generates a call to action for crypto tips/donations., Fetches crypto wallet addresses from database configuration.         Returns ava (+17 more)
...
Cohesion: 0.11
Nodes (16): Auth, BasicAuth, Base class for all authentication handlers., HTTP Basic Authentication., BaseClient, Limits, The main Client and AsyncClient classes. BaseClient holds all shared logic. Clie, Asynchronous HTTP client. (+8 more)
...
Cohesion: 0.08
Nodes (22): id, CircuitBreaker, Manually reset the circuit breaker to closed state., Simple circuit breaker to prevent cascading failures, JobIdAdapter, Recursively estimates memory size of input objects synchronously to prevent DOS, Recursively estimates memory size of input objects synchronously to prevent DOS, Fast-fail structured validation checks on rendering parameters to prevent wastin (+14 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (24): Execute a single workflow step (placeholder), Execute a single workflow step.          Hardened: Transitioned from placeholder, Get status of a workflow, Get status of a workflow, list all active workflows, list all active workflows, Get status of a workflow, Get status of a workflow (+16 more)
...
Cohesion: 0.1
Nodes (34): extract_go(), extract_js(), extract_rust(), Extract classes, functions, arrow functions, and imports from a .js/.ts/.tsx fil, Extract functions, methods, type declarations, and imports from a .go file., Extract functions, structs, enums, traits, impl methods, and use declarations fr, Methods on the same receiver type must share one canonical type node., Methods on the same receiver type must share one canonical type node. (+26 more)
...
Cohesion: 0.06
Nodes (31): ABTest, [activeEngine, setActiveEngine], [activeTests, setActiveTests], { agents, logs: systemLogs, status, pulse }, [completedTests, setCompletedTests], fetchData, fetchDetail, handleDetermineWinner() (+23 more)
...
Cohesion: 0.1
Nodes (23): cluster_health(), HeartbeatRequest, JobStore, node_pulse_heartbeat(), provision_node(), ProvisionNodeRequest, proxy_post(), proxy_status() (+15 more)
...
Cohesion: 0.07
Nodes (25): burnOpacity, burnTranslateX, CinematicOverlay(), CinematicOverlayProps, frame, ColorGradeProps, GradeType, SceneTransition() (+17 more)
...
Cohesion: 0.06
Nodes (30): [actionLogs, setActionLogs], [activeEngine, setActiveEngine], [activeNiche, setActiveNiche], [activeRegion, setActiveRegion], { agents, logs: systemLogs, pulse }, [alerts, setAlerts], [analysisTasks, setAnalysisTasks], [candidates, setCandidates] (+22 more)
...
Cohesion: 0.08
Nodes (24): PublishingService, Real Social Media Publishing Service ==================================== Handle, Unified service for multi-platform publishing., Publish video to specified platform.                  Args:             use_auto, Unified service for multi-platform publishing with resilience., Unified service for multi-platform publishing with resilience., Publish video to specified platform with fallback logic., Publish video to specified platform with fallback logic. (+16 more)
...
Cohesion: 0.09
Nodes (25): check_update(), _has_non_code(), _notify_only(), Check for pending semantic update flag and notify the user if set.      Cron-saf, Write a flag file and print a notification (fallback for non-code-only corpora)., Watch watch_path for new or modified files and auto-update the graph.      For c, Re-run AST extraction + build + cluster + report for code files. No LLM needed., _rebuild_code() (+17 more)
...
Cohesion: 0.07
Nodes (17): intelligence_hub(), Unit tests for IntelligenceHub - Central LLM routing service. Tests circuit brea, Test complexity-based provider routing., Test low complexity routes to ollama., Test medium complexity routes to gemini when available., Test high complexity routes to openai when available., Create an IntelligenceHub instance with mocked dependencies., Test chat functionality. (+9 more)
...
Cohesion: 0.07
Nodes (23): [actionLogs, setActionLogs], [activeEngine, setActiveEngine], AgentCapability, { agents, logs: systemLogs, status, pulse }, [capabilities, setCapabilities], categorizedCapabilities, chatEndRef, ChatMessage (+15 more)
...
Cohesion: 0.07
Nodes (26): clear_dependency_overrides(), db_session(), override_current_user(), Database session for testing, Test video generation workflows, Test that premium quality triggers pro workflow, Database session for testing, isolated per test function, Test video generation workflows (+18 more)
...
Cohesion: 0.12
Nodes (9): OpenClawAgent, Get API key from vault or fall back to settings, Get setting from vault or fall back to settings, Get setting from vault or fall back to settings, Get API key from vault or fall back to settings, Get setting from vault or fall back to settings, Fetch users with async HTTP client and circuit breaking, demo_openclaw_discovery() (+1 more)
...
Cohesion: 0.07
Nodes (27): AgentRequest, analyze_code(), AuditRequest, chat_with_agent(), ChatMessage, CodeRequest, generate_trademark(), get_agent_capabilities() (+19 more)
...
Cohesion: 0.1
Nodes (16): BotManager, broadcast_message(), BroadcastRequest, CircuitBreaker, _fetch_users_with_bots(), Twilio Webhook for incoming WhatsApp messages., Twilio Webhook for incoming WhatsApp messages., Twilio Webhook for incoming WhatsApp messages. (+8 more)

### Community 161 - "Community 161"
Cohesion: 0.1
Nodes (20): NewAIBridge(), Config, getEnv(), healthHandler(), init(), multiScanHandler(), NewDiscoveryService(), DiscoveryService (+12 more)
...
Cohesion: 0.08
Nodes (23): clear_all_faults(), custom_rate_limit_exceeded_handler(), get_chaos_report(), global_exception_handler(), induce_exhaustion(), inject_latency(), Adds artificial delay to a service., Simulates a worker crash notification. (+15 more)
...
Cohesion: 0.1
Nodes (12): BearerAuth, DigestAuth, NetRCAuth, Authentication handlers. Auth objects are callables that modify a request before, Load credentials from ~/.netrc based on the request host., Modify the request. May yield to inspect the response., Bearer token authentication., HTTP Digest Authentication.     Requires a full request/response cycle: sends th (+4 more)
...
Cohesion: 0.1
Nodes (6): CircuitBreaker, Simple circuit breaker to prevent cascading failures, MembershipStrategy, Patreon/Membership strategy - Recurring revenue through supporter tiers, Fetches membership tiers from database configuration.         Returns available, Generates a call to action for membership/support.

### Community 173 - "Community 173"
Cohesion: 0.12
Nodes (24): cohesion_score(), _partition(), Community detection on NetworkX graphs. Uses Leiden (graspologic) if available,, Run a second Leiden pass on a community subgraph to split it further., Context manager to suppress stdout/stderr during library calls.      graspologic, Ratio of actual intra-community edges to maximum possible., Run community detection. Returns {node_id: community_id}.      Tries Leiden (gra, score_all() (+16 more)
...
Cohesion: 0.11
Nodes (20): analyze_vlm_endpoint(), download(), generate_voice_endpoint(), get_job_status(), hunyuan_endpoint(), _inject_tensor_default(), list_models(), LLMRequest (+12 more)
...
Cohesion: 0.08
Nodes (16): MotionGraphicsService, Add animated text overlay at specific timestamps.          Args:             vid, Add animated text overlay at specific timestamps.          Args:             vid, Any motion graphics enhancement for video processing.     Adds animated text ove, Add watermark to video.          Args:             video_path: Path to input vid, Add watermark to video.          Args:             video_path: Path to input vid, Any motion graphics enhancement for video processing.     Adds animated text ove, Motion Graphics Service - Any Tier 3 Enhancement  Adds text animations, overlays (+8 more)

### Community 188 - "Community 188"
Cohesion: 0.09
Nodes (20): Attempt to consume credits for an action.         Returns (success, message), Attempt to consume credits for an action.         Returns (success, message), Attempt to consume credits for an action.         Returns (success, message), Attempt to consume credits for an action.         Returns (success, message), Add credits to user's balance, Add credits to user's balance, Add credits to user's balance, Add credits to user's balance (+12 more)
...
Cohesion: 0.09
Nodes (9): geistMono, geistSans, metadata, captureError(), GlobalErrorBoundary, AuthProvider(), TelemetryProvider(), UIProvider() (+1 more)
...
Cohesion: 0.08
Nodes (24): code:powershell (New-Item -ItemType Directory -Force -Path graphify-out | Out), code:powershell (python -c "), code:powershell (python -c "), code:powershell (python -c "), code:powershell (python -c "), code:powershell (# Detect Python and install graphify if needed), code:powershell (python -c "), code:powershell (python -c ") (+16 more)
...
Cohesion: 0.08
Nodes (24): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (# Detect the correct Python interpreter (handles pipx, venv,) (+16 more)

### Community 197 - "Community 197"
Cohesion: 0.1
Nodes (13): When settings obj lacks AUTOMATION_MODE, falls through to system default., Core enum values, parsing, validation, and threshold comparisons., Mode resolution priority chain., TestAutomationModeEnum, TestResolveMode, from_str(), is_at_least(), mode_to_int() (+5 more)
...
Cohesion: 0.09
Nodes (16): check_cv2_available(), check_moviepy_available(), Returns health of local Video Processing drivers., Returns health of local Video Processing drivers., Verify video can be read by iterating frames., Verify video can be read by iterating frames., Create OpenCV-based video processing when MoviePy hangs.         This is a simpl, Create OpenCV-based video processing when MoviePy hangs.         This is a simpl (+8 more)

### Community 205 - "Community 205"
Cohesion: 0.11
Nodes (22): _make_extraction(), Tests for confidence_score on edges., Report summary line should include avg confidence for INFERRED edges., Report summary line should include avg confidence for INFERRED edges., Surprising connections section shows confidence score next to INFERRED edges., Surprising connections section shows confidence score next to INFERRED edges., Return a minimal extraction dict with one edge of each confidence type., Return a minimal extraction dict with one edge of each confidence type. (+14 more)
...
Cohesion: 0.12
Nodes (13): Exception, PayPalService, Create a subscription, PayPal integration for payments.     Supports: Checkout, Subscriptions, Webhooks, Verify PayPal webhook signature, Get PayPal access token, Create a PayPal order, CookieConflict (+5 more)
...
Cohesion: 0.1
Nodes (19): create_google_flow(), google_auth(), google_auth_callback(), Google OAuth callback endpoint.     Handles the redirect from Google after user, Google OAuth callback endpoint.     Handles the redirect from Google after user, Google OAuth callback endpoint.     Handles the redirect from Google after user, Create a configured Google OAuth flow instance., Create a configured Google OAuth flow instance. (+11 more)
...
Cohesion: 0.1
Nodes (14): Simulates handheld motion by applying small random position offsets.         Use, Simulates handheld motion by applying small random position offsets.         Use, Adds a subtle film grain effect to simulate analog texture (f10)., Adds a subtle film grain effect to simulate analog texture (f10)., Converts video to black and white for the Noir style (f11)., Converts video to black and white for the Noir style (f11)., Applies a random glitch effect by shifting RGB channels or adding noise (f12)., Applies a random glitch effect by shifting RGB channels or adding noise (f12). (+6 more)

### Community 223 - "Community 223"
Cohesion: 0.13
Nodes (12): FFmpeg Video Transformation Utilities ====================================  Prof, check_cv2_available(), check_easyocr_available(), OCRService, Analyzes the video and returns a placement strategy: 'bottom' (default), 'top',, Analyzes the video and returns a placement strategy: 'bottom' (default), 'top',, Lazy initialization of the EasyOCR reader., Lazy initialization of the EasyOCR reader. (+4 more)
...
Cohesion: 0.12
Nodes (17): Check if user can afford action and consume credits, Check if user can afford action and consume credits, Check if user can afford action and consume credits, Check if user can afford action and consume credits, Get or create user's credit balance, Get or create user's credit balance, Get or create user's credit balance, Get user's credit balance (+9 more)
...
Cohesion: 0.12
Nodes (13): _fetch_youtube_data(), _generate_ai_insight(), build(), build_merge(), deduplicate_by_label(), _norm_label(), _normalize_id(), Merge multiple extraction results into one graph.      directed=True produces a (+5 more)

### Community 228 - "Community 228"
Cohesion: 0.12
Nodes (7): CacheManager, createProcessor(), DataProcessor, GraphifyDemo, IProcessor, Loggable, Processor
...
Cohesion: 0.16
Nodes (18): assert_valid(), Validate an extraction JSON dict against the graphify schema.     Returns a list, Raise ValueError with all errors if extraction is invalid., validate_extraction(), build(), build_from_json(), Merge multiple extraction results into one graph., test_assert_valid_passes_silently() (+10 more)
...
Cohesion: 0.1
Nodes (20): code:bash (mkdir -p graphify-out), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c "), code:bash (# Detect the correct Python interpreter (handles pipx, venv,), code:bash (python3 -m graphify.serve graphify-out/graph.json), code:bash ($(cat .graphify_python) -c "), code:bash ($(cat .graphify_python) -c ") (+12 more)
...
Cohesion: 0.12
Nodes (13): AI ASSISTANT - Works WITH Professional Editors, Not Against Them     ===========, AI ASSISTANT - Works WITH Professional Editors, Not Against Them     ===========, Score videos WITH EXPLANATIONS - not just numbers.          Each score includes:, Score videos WITH EXPLANATIONS - not just numbers.          Each score includes:, Generate human-readable reasoning for score, Generate human-readable reasoning for score, Generate considerations for the editor, Generate considerations for the editor (+5 more)

### Community 256 - "Community 256"
Cohesion: 0.13
Nodes (13): IntelligentVideoResearcher, Performs human-like video research and discovery, Performs human-like video research and discovery, Research and find videos for each scene requirement, Research and find videos for each scene requirement, Generate human-like search terms for the scene, Generate human-like search terms for the scene, Perform intelligent search for scene-specific videos (+5 more)
...
Cohesion: 0.11
Nodes (18): Temporary token directory for publisher tests., Verify TikTok/Instagram publishing falls back to manual action when automation i, Verify TikTok/Instagram publishing falls back to manual action when automation i, Temporary token directory for publisher tests., Verify publishing to multiple platforms in parallel., Verify publishing to multiple platforms in parallel., Verify loading YouTube credentials from json files., Verify loading YouTube credentials from json files. (+10 more)

### Community 260 - "Community 260"
Cohesion: 0.11
Nodes (12): Fetch YouTube analytics data, Fetch YouTube analytics data, Fetch analytics from social media platforms, Fetch analytics from social media platforms, Fetch metrics from specific social platform, Fetch metrics from specific social platform, Get Instagram post metrics, Get Instagram post metrics (+4 more)
...
Cohesion: 0.12
Nodes (14): get_current_user(), login(), reset_password(), bootstrap(), populate_niches(), Populate default niches for discovery, Populate default niches for discovery, repair_admin() (+6 more)

### Community 264 - "Community 264"
Cohesion: 0.16
Nodes (12): ConnectionManager, WebSocket endpoint for real-time system logs (e.g., Agent Zero, Discovery Scans), WebSocket endpoint for real-time system logs (e.g., Agent Zero, Discovery Scans), WebSocket endpoint for real-time system logs (e.g., Agent Zero, Discovery Scans), Callback for the DistributedEventBus to broadcast events to WS clients, Callback for the DistributedEventBus to broadcast events to WS clients, Listens to both legacy PubSub and modern Redis Streams (Event Bus)., Listens to both legacy PubSub and modern Redis Streams (Event Bus). (+4 more)

### Community 265 - "Community 265"
Cohesion: 0.11
Nodes (17): [actionLogs, setActionLogs], [activeEngine, setActiveEngine], { agents, logs: systemLogs, lastJobUpdate, pulse, status }, displayLogs, engine, exists, fetchData(), fetchInsight() (+9 more)

### Community 266 - "Community 266"
Cohesion: 0.11
Nodes (14): CrewAIService, EttamettaCrew, Any CrewAI multi-agent orchestration integration.     Disabled by default - enab, Any CrewAI multi-agent orchestration integration.     Disabled by default - enab, Create a CrewAI agent with role and goal., Create a CrewAI agent with role and goal., Create a task for an agent., Create a task for an agent. (+6 more)
...
Cohesion: 0.11
Nodes (18): code:block1 (/graphify                                             # full), code:bash (if [ ! -f graphify-out/.graphify_python ]; then), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (python3 -m graphify.watch INPUT_PATH --debounce 3), code:bash (graphify hook install    # install), code:bash (graphify claude install), code:bash (graphify claude uninstall  # remove the section) (+10 more)
...
Cohesion: 0.12
Nodes (12): ChaosUtility, ChaosUtility: Orchestrated Failure Injection Engine.  Supports individual fault, Stops the continuous chaos loop and clears all active faults., Stops the continuous chaos loop and clears all active faults., The Infrastructure Destroyer — with Orchestration.     Injects controlled failur, Returns current chaos state and recent injection history., Returns current chaos state and recent injection history., The Infrastructure Destroyer — with Orchestration.     Injects controlled failur (+4 more)
...
Cohesion: 0.11
Nodes (5): Delegate to standalone validation function., Delegate to standalone validation function., Delegate to standalone validation logging function., Delegate to standalone validation logging function., Settings
...
Cohesion: 0.15
Nodes (15): Video Generation Models Package  Local and Remote video generation models for et, apply_quantization(), generate_ltx(), generate_ltx_api(), generate_ltx_dummy(), load_ltx_local(), LTX-Video Inference Module  LTX-Video is an motion-optimized video generation mo, Generate video using LTX-Video (480p) (+7 more)
...
Cohesion: 0.12
Nodes (11): Queries local database for cached candidates as fallback when scanners return no, Queries local database for cached candidates as fallback when scanners return no, Applies selective monetization mode filtering and user specific constraints., Applies selective monetization mode filtering and user specific constraints., Persists trending content candidates in a single batch transaction., Persists trending content candidates in a single batch transaction., Recalculates viral scores based on real-time velocity for each candidate., Ingests discovery signal into base_signal_bus. (+3 more)
...
Cohesion: 0.12
Nodes (17): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (# Detect the correct Python interpreter (handles pipx, venv,), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash ($(cat graphify-out/.graphify_python) -c ") (+9 more)
...
Cohesion: 0.12
Nodes (10): Determine base Remotion executable and initial arguments., Determine base Remotion executable and initial arguments., Wrap the Remotion execution with 'nice' priority adjustment if available., Wrap the Remotion execution with 'nice' priority adjustment if available., Extract frame duration arguments safely from props., Extract frame duration arguments safely from props., Safely builds the executable program and argument array for Remotion rendering., Attempts to read the container memory limit from cgroups (v1 or v2). (+2 more)

### Community 314 - "Community 314"
Cohesion: 0.12
Nodes (12): High-fidelity video assembly using Remotion React engine with node-level trackin, High-fidelity video assembly using Remotion React engine with node-level trackin, High-fidelity video assembly using Remotion React engine with node-level trackin, High-fidelity video assembly using Remotion React engine with node-level trackin, Concatenate voiceover clips into a single master file., Determine duration in frames by probing the master audio., Concatenate voiceover clips into a single master file., Get word-level transcription for dynamic captions. (+4 more)
...
Cohesion: 0.17
Nodes (10): OpenInterpreterService, Execute JavaScript code., Execute JavaScript code., Generate a video processing script for the topic., Generate a video processing script for the topic., Open Interpreter integration for code execution.     Enable with ENABLE_INTERPRE, Open Interpreter integration for code execution.     Enable with ENABLE_INTERPRE, Execute code in a sandboxed environment.          Args:             code: Code t (+2 more)
...
Cohesion: 0.15
Nodes (10): FlywheelService, The 'Find Winners Fast' Flywheel.     Automates the Kill & Scale loop:     - Pru, Runs an evolution cycle across all active niches in the platform., Runs an evolution cycle across all active niches in the platform., Calculates the 10/10 growth score.         score = (CTR * 0.4) + (retention * 0., Calculates the 10/10 growth score.         score = (CTR * 0.4) + (retention * 0., 1. Fetches metrics for all variants of a parent job.         2. Scores them., 1. Fetches metrics for all variants of a parent job.         2. Scores them. (+2 more)
...
Cohesion: 0.26
Nodes (14): generate(), Mirrors export.safe_name so community hub filenames and report wikilinks always, _safe_community_name(), make_inputs(), test_report_contains_ambiguous_section(), test_report_contains_communities(), test_report_contains_corpus_check(), test_report_contains_god_nodes() (+6 more)
...
Cohesion: 0.12
Nodes (15): code:block1 (/graphify                                             # full), code:powershell (python -c "), code:powershell (python -c "), code:powershell (python -m graphify.watch INPUT_PATH --debounce 3), code:bash (graphify hook install    # install), For --cluster-only, For git commit hook, For /graphify add (+7 more)
...
Cohesion: 0.16
Nodes (9): auth_linkedin_callback(), api_key(), bucket(), endpoint(), provider(), region(), get_secret(), Synchronous implementation of get_secret.     Avoids asyncio issues in Celery wo (+1 more)
...
Cohesion: 0.15
Nodes (11): CrewAIService, Elite CrewAI multi-agent orchestration.     Uses dynamic task generation to tail, Uses an LLM to generate specific tasks for the crew based on the topic., Uses an LLM to generate specific tasks for the crew based on the topic., Elite CrewAI multi-agent orchestration.     Uses dynamic task generation to tail, Uses an LLM to generate specific tasks for the crew based on the topic., Re-initialize service from current environment/settings., Re-initialize service from current environment/settings. (+3 more)
...
Cohesion: 0.15
Nodes (11): Get the cookie file path for a user+platform, with global fallback., Get the cookie file path for a user+platform, with global fallback., Get the cookie file path for a user+platform, with global fallback., Save Chrome session cookies for a user+platform.          Args:             user, Save Chrome session cookies for a user+platform.          Args:             user, Verify if a user's session for a platform is valid.          Returns:, Verify if a user's session for a platform is valid.          Returns:, Verify if a user's session for a platform is valid.          Returns: (+3 more)
...
Cohesion: 0.13
Nodes (13): analyze_viral_pattern_task(), deep_scan_task(), Background task that iterates through all active niches and triggers discovery., Background task for deep, intelligent discovery scan across multiple niches., Background task for deep, intelligent discovery scan across multiple niches., Background task that iterates through all active niches and triggers discovery., Background task for real-time trend scanning using DiscoveryService., Background task for real-time trend scanning using DiscoveryService. (+5 more)

### Community 341 - "Community 341"
Cohesion: 0.18
Nodes (14): custom_rate_limit_exceeded_handler(), global_exception_handler(), http_exception_handler(), Register all exception handlers on the FastAPI app., Normalize HTTPException to standard nested error format., register_exception_handlers(), sqlalchemy_exception_handler(), validation_exception_handler() (+6 more)
...
Cohesion: 0.13
Nodes (13): [actionLogs, setActionLogs], [activeEngine, setActiveEngine], { agents, logs: systemLogs, status, pulse }, AnalyticsMetrics, engine, fetchAnalytics, GlobalPulseGlobe, handleExport() (+5 more)

### Community 346 - "Community 346"
Cohesion: 0.13
Nodes (10): Elite Cinematic Fusion (Tier 10): Rhythmic & Emotional Alignment, Elite Cinematic Fusion (Tier 10): Rhythmic & Emotional Alignment, Fusion Assembly with cinematic color grading and Rhythmic Audio Mixing, Fusion Assembly with cinematic color grading and Rhythmic Audio Mixing, Analyze scenes for motion and semantics, Analyze scenes for motion and semantics, Logic for picking the absolute best viral leads, Logic for picking the absolute best viral leads (+2 more)
...
Cohesion: 0.16
Nodes (9): CommerceService, Fetches Shopify credentials from DB settings., Fetches Shopify credentials from DB settings., Fetches products from Shopify. Falls back to database affiliate links if store i, Fetches products from Shopify. Falls back to database affiliate links if store i, Calls Shopify Admin API to get products., Calls Shopify Admin API to get products., Generates a direct checkout URL.          Note: Shopify direct cart links usuall (+1 more)
...
Cohesion: 0.14
Nodes (10): ALL_PLATFORMS, handlePublish(), [injectMonetization, setInjectMonetization], [isSubmitting, setIsSubmitting], MultiPublishModalProps, [niche, setNiche], [results, setResults], [selectAll, setSelectAll] (+2 more)
...
Cohesion: 0.16
Nodes (10): PaperclipKPITool, Record and compare KPIs to previous baseline., Record and compare KPIs to previous baseline., Simple heuristic for autonomous scaling., Simple heuristic for autonomous scaling., Entry point for Agent Zero tool execution., Entry point for Agent Zero tool execution., Paperclip KPI tracking tool for Agent Zero. (+2 more)
...
Cohesion: 0.15
Nodes (12): Verify that modulated values respect their defined mathematical boundaries., Verify that modulated values respect their defined mathematical boundaries., Verify that the same seed produces identical modulated configs, while different, Verify that the same seed produces identical modulated configs, while different, Verify that theme presets correctly override base configurations and apply their, Verify that theme presets correctly override base configurations and apply their, Verify that modulator injects missing keys or dictionary structures gracefully., Verify that modulator injects missing keys or dictionary structures gracefully. (+4 more)
...
Cohesion: 0.17
Nodes (10): LangChainService, Maintain conversation context with memory.                  Args:             us, Maintain conversation context with memory.                  Args:             us, Maintain conversation context with memory.                  Args:             us, Any LangChain enhancement for LLM orchestration.          Disabled by default -, Any LangChain enhancement for LLM orchestration.          Disabled by default -, Re-initialize service from current environment/settings., Re-initialize service from current environment/settings. (+2 more)
...
Cohesion: 0.15
Nodes (7): VideoFileClip, Applies 'Copyright-Safe' transformations using high-performance FFmpeg., Applies 'Copyright-Safe' transformations using high-performance FFmpeg., Merge multiple clips into one.         Uses fast FFmpeg concat demuxer (instant), Merge multiple clips into one.         Uses fast FFmpeg concat demuxer (instant), Assembles multi-scene stories with precise voice-visual alignment., Assembles multi-scene stories with precise voice-visual alignment.
...
Cohesion: 0.18
Nodes (9): Check availability of optional heavy dependencies., Generate a detailed report of missing dependencies and their impact., Generate a detailed report of missing dependencies and their impact., Get API key from vault or fall back to settings, Generate a detailed report of missing dependencies and their impact., is_package_available(), Decorator or helper to verify a package is available before running a function., Check if a python package is installed in the current environment. (+1 more)
...
Cohesion: 0.17
Nodes (8): Helper to verify disk space is sufficient before writing., Helper to verify disk space is sufficient before writing., Write serialized bytes to a temp file, flush/fsync, and atomically replace the d, Write serialized bytes to a temp file, flush/fsync, and atomically replace the d, Safely delete the temp file if it exists, ignoring exceptions., Safely delete the temp file if it exists, ignoring exceptions., Helper to serialize props to disk atomically with disk checks and retries. Execu, Helper to serialize props to disk atomically with disk checks and retries. Execu
...
Cohesion: 0.21
Nodes (6): InVideoAISkill, InVideo AI browser automation skill - Tier 1 easy platform     AI-powered video, Clean up browser resources, Polymorphic entry point for OpenClaw agent., Initialize stealth browser session, Generate video from prompt using InVideo AI         Returns: { status: success/f
...
Cohesion: 0.21
Nodes (6): Vidu browser automation skill - Tier 1 easy     Multi-shot narrative support, Clean up browser resources, Polymorphic entry point for OpenClaw agent., Initialize stealth browser session, Generate video from prompt using Vidu         Returns: { status: success/failed,, ViduSkill

### Community 418 - "Community 418"
Cohesion: 0.21
Nodes (6): FlikiSkill, Fliki browser automation skill - Tier 1 easy platform     Text-to-video with voi, Clean up browser resources, Polymorphic entry point for OpenClaw agent., Initialize stealth browser session, Generate video from prompt using Fliki         Returns: { status: success/failed
...
Cohesion: 0.17
Nodes (11): auto_broadcast(), generate_package(), get_supported_platforms(), Core publishing routes — platforms, package generation, single/multi-platform po, Get list of all supported platforms for publishing, Get list of all supported platforms for publishing, Triggers autonomous broadcast pattern.     Scans for pending/scheduled content a, Triggers autonomous broadcast pattern.     Scans for pending/scheduled content a (+3 more)
...
Cohesion: 0.17
Nodes (10): Aggregate reports from media drivers and internal GPU status., Aggregate reports from media drivers and internal GPU status., Aggregate reports from media drivers and internal GPU status., Aggregate reports from media drivers and internal GPU status., Returns real-time health for the dashboard., Returns real-time health for the dashboard., Returns real-time health for the dashboard., Aggregate reports from media drivers and internal GPU status. (+2 more)

### Community 441 - "Community 441"
Cohesion: 0.17
Nodes (9): Test service initialization., Test service initialization., Verify circuit breaker is properly initialized., Verify circuit breaker is properly initialized., Verify model manager is initialized., Verify model manager is initialized., Verify GPU queue is initialized., Verify GPU queue is initialized. (+1 more)

### Community 442 - "Community 442"
Cohesion: 0.17
Nodes (9): Test engine parameter configuration., Test engine parameter configuration., Test Hunyuan engine parameters., Test Hunyuan engine parameters., Test Mochi engine parameters., Test Mochi engine parameters., Test default engine parameters for unknown engine., Test default engine parameters for unknown engine. (+1 more)
...
Cohesion: 0.24
Nodes (9): generate_bot_code(), get_available_filters(), get_settings(), _is_redacted_placeholder(), _is_sensitive_key(), Generate a code for bot configuration, Generate a code for bot configuration, _redact_settings() (+1 more)
...
Cohesion: 0.24
Nodes (7): area(), Circle, describe(), Geometry, Point, Shape, LinearAlgebra

### Community 460 - "Community 460"
Cohesion: 0.18
Nodes (11): extract_julia(), Extract modules, structs, functions, imports, and calls from a .jl file., test_julia_finds_abstract_type(), test_julia_finds_calls(), test_julia_finds_functions(), test_julia_finds_imports(), test_julia_finds_inherits(), test_julia_finds_module() (+3 more)
...
Cohesion: 0.2
Nodes (6): Test resetting all circuit breakers., Test circuit breaker integration., Verify circuit breaker opens after threshold failures., Verify circuit breaker closes after successful call., Test manual circuit breaker reset., TestIntelligenceHubCircuitBreaker
...
Cohesion: 0.36
Nodes (4): Scanner, calculateVelocity(), classifyURL(), ScanResult
...
Cohesion: 0.2
Nodes (9): test_affiliate_service_link_generation(), test_complete_with_fallback(), test_generate_screenplay(), test_generate_script_structure(), test_generate_visual_strategy(), test_interpreter_process_isolation(), test_is_available_checks_provider(), test_plan_affiliate_insertions() (+1 more)
...
Cohesion: 0.24
Nodes (5): MockFailingStrategy, MockWorkingStrategy, Verify that the orchestrator fails over to a working strategy when the primary f, Verify that the orchestrator fails over to a working strategy when the primary f, test_orchestrator_failover()

### Community 512 - "Community 512"
Cohesion: 0.2
Nodes (7): mock_video_dir(), Test that Wan API sends the correct payload to the remote GPU node., Test that Wan API sends the correct payload to the remote GPU node., Test that VideoProcessor downloads remote assets during assembly., Test that VideoProcessor downloads remote assets during assembly., TestHardenedVideoInference, TestHardenedVideoProcessor

### Community 513 - "Community 513"
Cohesion: 0.24
Nodes (8): generate_mochi(), generate_mochi_api(), load_mochi_model(), Mochi-1 Inference Module  Mochi-1 is a state-of-the-art open-source video genera, Generate video using Mochi-1, Generate video using Replicate/Fal.ai API or Remote GPU, Test that Mochi API sends the correct payload to the remote GPU node., Test that Mochi API sends the correct payload to the remote GPU node.
...
Cohesion: 0.2
Nodes (8): Authentication Endpoint Tests ============================ Integration tests for, Test token refresh endpoints., Test token refresh endpoints., Test token refresh endpoints., Test getting current user without token., Test getting current user without token., Test getting current user without token., TestTokenRefresh

### Community 517 - "Community 517"
Cohesion: 0.2
Nodes (8): Test user registration endpoints., Test user registration endpoints., Test registering a new user., Test registering a new user., Test registering with an existing email fails., Test registering with an existing email fails., Test registering with an existing email fails., TestRegistration

### Community 518 - "Community 518"
Cohesion: 0.2
Nodes (6): The ettametta: Neural Production Engine (10.0/10)     ==========================, The ettametta: Neural Production Engine (10.0/10)     ==========================, RealVideoFusionEngine, test_fusion_engine_hardening(), verify_cinematic_intuition(), verify_cinematic_intuition()
...
Cohesion: 0.22
Nodes (9): Handle Telegram bot webhook for configuration, Handle Telegram bot webhook for configuration, telegram_webhook(), configure_telegram_bot(), Send a message via Telegram Bot API.      Args:         bot_token: Telegram bot, Configure Telegram bot for user by sending a confirmation message.      Args:, Configure Telegram bot for user by sending a confirmation message.      Args:, Send a message via Telegram Bot API.      Args:         bot_token: Telegram bot (+1 more)
...
Cohesion: 0.2
Nodes (8): Generate video with specific provider, Generate video with specific provider, Generate video with specific provider, Generate video with specific provider, Apply style preset to prompt, Apply style preset to prompt, Apply style preset to prompt, Apply style preset to prompt
...
Cohesion: 0.2
Nodes (9): FreeVideoProviderService, Multi-provider AI video generation service.     Supports multiple free-tier vide, Multi-provider AI video generation service.     Supports multiple free-tier vide, Multi-provider AI video generation service.     Supports multiple free-tier vide, Multi-provider AI video generation service.     Supports multiple free-tier vide, Generate video using browser automation (no API key required).         Falls bac, Generate video using browser automation (no API key required).         Falls bac, Generate video using browser automation (no API key required).         Falls bac (+1 more)
...
Cohesion: 0.22
Nodes (6): Load skills from external YAML configuration., Load skills from external YAML configuration., Construct the system prompt by injecting dynamic skills., Construct the system prompt by injecting dynamic skills., Check availability of optional heavy dependencies., Construct the system prompt by injecting dynamic skills.
...
Cohesion: 0.22
Nodes (6): Create detailed step-by-step editing guide, Create detailed step-by-step editing guide, Generate detailed step-by-step editing instructions, Generate detailed step-by-step editing instructions, Create troubleshooting guide for common issues, Create troubleshooting guide for common issues
...
Cohesion: 0.22
Nodes (6): Generate script that matches the extracted clips., Generate script that matches the extracted clips., Fuse clips together with transitions and sync voiceover., Fuse clips together with transitions and sync voiceover., Complete autonomous video creation pipeline:         1. Discover viral videos ma, Complete autonomous video creation pipeline:         1. Discover viral videos ma

### Community 552 - "Community 552"
Cohesion: 0.22
Nodes (6): AutonomousVideoRemixer, Autonomous Video Remix Service ============================== Complete pipeline:, Fully autonomous video creation from discovered viral content.     Chains multip, Fully autonomous video creation from discovered viral content.     Chains multip, Generate AI voiceover for the script., Generate AI voiceover for the script.
...
Cohesion: 0.25
Nodes (8): process_high_potential_candidates(), Autonomous task that picks up high-potential content candidates     and triggers, Verifies that already processed candidates are not re-triggered., Integration test for the autonomous Nexus engine trigger.     Verifies that high, Verifies that already processed candidates are not re-triggered., Integration test for the autonomous Nexus engine trigger.     Verifies that high, test_process_high_potential_candidates_skips_processed(), test_process_high_potential_candidates_trigger()
...
Cohesion: 0.22
Nodes (7): Test video job listing and status endpoints., Test video job listing and status endpoints., Test getting specific job metadata., Test getting specific job metadata., Test video job listing and status endpoints., Test getting specific job status., TestVideoJobs
...
Cohesion: 0.22
Nodes (9): Handle WhatsApp webhook for configuration, Handle WhatsApp webhook for configuration, whatsapp_webhook(), configure_whatsapp_bot(), Send a message via WhatsApp using Twilio API.      Args:         account_sid: Tw, Send a message via WhatsApp using Twilio API.      Args:         account_sid: Tw, Configure WhatsApp bot for user by sending a confirmation message.      Args:, Configure WhatsApp bot for user by sending a confirmation message.      Args: (+1 more)
...
Cohesion: 0.29
Nodes (5): BrandingSkill, Polymorphic entry point for OpenClaw agent., Polymorphic entry point for OpenClaw agent., Generate brand identity (Logo, Name, Color) using AI.         Runs inside OpenCl, Generate brand identity (Logo, Name, Color) using AI.         Runs inside OpenCl
...
Cohesion: 0.25
Nodes (6): Check if opencli is enabled and binary exists., Check if opencli is enabled and binary exists., Check if opencli is enabled and binary exists., Get a summary of all platform connections for a user., Get a summary of all platform connections for a user., Get a summary of all platform connections for a user.
...
Cohesion: 0.29
Nodes (6): get_auth_token(), Integration Tests Tests database transactions, service integrations, and cross-e, Integration tests for Persona, Integration tests for Persona, TestPersonaIntegration, token()
...
Cohesion: 0.25
Nodes (7): EXECUTIVE SUMMARY, FULLY REAL (24 services), PARTIAL (4 services), SECTION 6: SERVICES CLASSIFICATION SUMMARY, SECTION 9: MISSING USE CASE SCENARIOS (Not Covered By Any Page), STUB/PLACEHOLDER (3 items), Viral Forge — UI/Backend Gap Analysis (March 2026)
...
Cohesion: 0.33
Nodes (6): Test login endpoints., Test login endpoints., Test login endpoints., Test login with valid credentials., Test login with valid credentials., TestLogin

### Community 660 - "Community 660"
Cohesion: 0.29
Nodes (6): notify_job_update_sync(), Synchronous utility (for Celery) to publish job updates to Redis., Synchronous utility (for Celery) to publish job updates to Redis., Synchronous utility (for Celery) to publish job updates to Redis., Abort a running video job.                  Args:             job_id: ID of the, Abort a running video job.                  Args:             job_id: ID of the
...
Cohesion: 0.33
Nodes (4): Prepare 3-5 EDITOR CHOICES, not just one result.          Each option includes:, Prepare 3-5 EDITOR CHOICES, not just one result.          Each option includes:, Extract audience insights from data, Extract audience insights from data
...
Cohesion: 0.33
Nodes (3): Generates an Advanced Substation Alpha (.ass) file for professional styling., Generates an Advanced Substation Alpha (.ass) file for professional styling., Generates a 'Viral Style' ASS file with word-by-word highlights.         This pr

### Community 693 - "Community 693"
Cohesion: 0.33
Nodes (3): QualityControl, Elite Production: Vision-Based Visual Auditor.     Extracts key frames and uses, Performs a multi-point visual audit of the rendered video.         Returns a sco
...
Cohesion: 0.4
Nodes (4): Renders a video using Remotion CLI., Transient error indicating external timeouts, Chromium resource exhaustion, or t, Main entrypoint orchestrating pre-validation, sandboxed asset preparation,, Main entrypoint orchestrating pre-validation, sandboxed asset preparation,
...
Cohesion: 0.4
Nodes (3): Test: Nexus composition flow, Test: Nexus composition flow, TestNexusFlow

### Community 729 - "Community 729"
Cohesion: 0.5
Nodes (4): get_auth_token(), E2E Flow Tests Tests complete user workflows: Login → Discovery → Create → Publi, Login and get auth token, token()
...
Cohesion: 0.4
Nodes (4): get_discovery_service_extended(), Extended Discovery Service Consolidates all discovery-related database operation, Factory for DiscoveryServiceExtended, Factory for DiscoveryServiceExtended
...
Cohesion: 0.4
Nodes (4): Get credit cost for an action (may vary by tier), Get credit cost for an action (may vary by tier), Get credit cost for an action (may vary by tier), Get credit cost for an action (may vary by tier)

### Community 734 - "Community 734"
Cohesion: 0.4
Nodes (5): bulk_update_user_settings(), Bulk update user-specific settings (non-admin users), Bulk update user-specific settings (non-admin users), Bulk update user-specific settings (non-admin users), Bulk update user-specific settings (non-admin users)

### Community 735 - "Community 735"
Cohesion: 0.4
Nodes (5): get_system_settings(), Get all system-wide settings (admin only), Get all system-wide settings (admin only), Get all system-wide settings (admin only), Get all system-wide settings (admin only)

### Community 736 - "Community 736"
Cohesion: 0.4
Nodes (5): Update system-wide settings (admin only), Update system-wide settings (admin only), Update system-wide settings (admin only), Update system-wide settings (admin only), update_system_settings()
...
Cohesion: 0.4
Nodes (5): _animate_persona(), Background task to generate persona animation via SadTalker/LivePortrait, Background task to generate persona animation via SadTalker/LivePortrait, Receives image + text, kicks off deepfake animation., Receives image + text, kicks off deepfake animation.

### Community 742 - "Community 742"
Cohesion: 0.4
Nodes (5): _generate_video(), Background task to synthesize and save video via Diffusers, Background task to synthesize and save video via Diffusers, Receives prompt from OpenClaw/ettametta, immediately returns a job ID,     and s, Receives prompt from OpenClaw/ettametta, immediately returns a job ID,     and s
...
Cohesion: 0.4
Nodes (4): Generate video using Luma Dream Machine, Generate video using Luma Dream Machine, Generate video using Luma Dream Machine, Generate video using Luma Dream Machine
...
Cohesion: 0.5
Nodes (3): create_the_ettametta_cycle(), Absolute 10.0 Cycle: Proactive Trending, Strategic Framing, and Empire Deploymen, Absolute 10.0 Cycle: Proactive Trending, Strategic Framing, and Empire Deploymen

### Community 811 - "Community 811"
Cohesion: 0.5
Nodes (3): main(), Main intelligent video discovery and editing workflow, Main intelligent video discovery and editing workflow
...
Cohesion: 0.5
Nodes (3): Get the appropriate model name for the current provider, Get the appropriate model name for the current provider, Get the appropriate model name for the current provider

### Community 815 - "Community 815"
Cohesion: 0.5
Nodes (4): execute_tool(), Execute an OpenClaw tool directly (Internal Only)., Execute an OpenClaw tool directly (Internal Only)., Execute an OpenClaw tool directly (Internal Only).

### Community 816 - "Community 816"
Cohesion: 0.5
Nodes (3): Initialize multiple LLM clients with fallback support, Initialize multiple LLM clients with fallback support, Initialize multiple LLM clients with fallback support
...
Cohesion: 0.5
Nodes (3): Use a prompt template with variables.                  Args:             templat, Use a prompt template with variables.                  Args:             templat, Use a prompt template with variables.                  Args:             templat

### Community 821 - "Community 821"
Cohesion: 0.5
Nodes (3): Dynamically check if CrewAI and required deps are installed., Dynamically check if CrewAI and required deps are installed., Dynamically check if CrewAI and required deps are installed.
...
Cohesion: 0.5
Nodes (3): Remove session cookies for a user+platform., Remove session cookies for a user+platform., Remove session cookies for a user+platform.
...
Cohesion: 0.5
Nodes (3): Integration tests for LLM service, Integration tests for LLM service, TestLLMIntegration

### Community 839 - "Community 839"
Cohesion: 0.5
Nodes (3): High-fidelity video transformation using Remotion.         Delegates the visual, High-fidelity video transformation using Remotion.         Delegates the visual, High-fidelity video transformation using Remotion.         Delegates the visual
...
Cohesion: 0.5
Nodes (3): Test that jobs list requires authentication., Test that jobs list requires authentication., Test that jobs list requires authentication.
...
Cohesion: 0.5
Nodes (3): Test getting current user with valid token., Test getting current user with valid token., Test getting current user with valid token.
...
Cohesion: 0.5
Nodes (3): Test registering with missing required fields., Test registering with missing required fields., Test registering with missing required fields.
...
Cohesion: 0.5
Nodes (3): Test login with missing credentials., Test login with missing credentials., Test login with missing credentials.

### Community 853 - "Community 853"
Cohesion: 0.5
Nodes (3): Passthrough to global DB trending results., Passthrough to global DB trending results., Passthrough to global DB trending results.
...
Cohesion: 0.5
Nodes (4): Receives frontend error reports from GlobalErrorBoundary., Receives frontend error reports from GlobalErrorBoundary., Receives frontend error reports from GlobalErrorBoundary., report_frontend_error()
...
Cohesion: 0.5
Nodes (4): Performs a real-time handshake/verification of an external service configuration, Performs a real-time handshake/verification of an external service configuration, Performs a real-time handshake/verification of an external service configuration, verify_service()

### Community 862 - "Community 862"
Cohesion: 0.5
Nodes (4): get_monetization_strategies(), Returns all available monetization strategies with their configuration status, Returns all available monetization strategies with their configuration status, Returns all available monetization strategies with their configuration status
...
Cohesion: 0.5
Nodes (3): execute(), Execute code in restricted environment., Execute code in restricted environment.
...
Cohesion: 0.5
Nodes (3): create_simple_real_video(), Create a real video by directly fusing downloaded videos, Create a real video by directly fusing downloaded videos

### Community 875 - "Community 875"
Cohesion: 0.5
Nodes (3): Calculate title similarity score (0.0 to 1.0) using word overlap., Calculate title similarity score (0.0 to 1.0) using word overlap., Calculate title similarity score (0.0 to 1.0) using word overlap.
...
Cohesion: 0.5
Nodes (4): code:powershell (python -c "), code:powershell (python -c "), code:powershell (python -m graphify save-result --question "Explain NODE_NAME), For /graphify explain
...
Cohesion: 0.67
Nodes (3): CodeExecutor, Simple code execution for ettametta automation., Simple code execution for ettametta automation.

### Community 984 - "Community 984"
Cohesion: 0.67
Nodes (3): Update user-specific settings including notifications and API integrations, Update user-specific settings including notifications and API integrations, update_user_settings()

### Community 985 - "Community 985"
Cohesion: 0.67
Nodes (3): get_user_settings(), Retrieve user-specific settings including notifications and API integrations, Retrieve user-specific settings including notifications and API integrations

### Community 986 - "Community 986"
Cohesion: 0.67
Nodes (3): publish_multi_platform(), Publish video to multiple platforms at once.     - Authenticated platforms will, Publish video to multiple platforms at once.     - Authenticated platforms will
...
Cohesion: 0.67
Nodes (3): code:bash ($(cat .graphify_python) -c "), code:block23 (Graph complete. Outputs in PATH_TO_DIR/graphify-out/), Step 9 - Save manifest, update cost tracker, clean up, and report
...
Cohesion: 0.67
Nodes (3): code:powershell (python -c "), code:powershell (python -c "), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag)
...
Cohesion: 0.67
Nodes (3): code:bash ($(cat .graphify_python) -c "), code:block25 (Graph complete. Outputs in PATH_TO_DIR/graphify-out/), Step 9 - Save manifest, update cost tracker, clean up, and report
...
## Knowledge Gaps
- **8369 isolated node(s):** `Demo: Discover content → Analyze → Generate AI videos`, `Demo: Discover → Analyze → Generate → Compile into final video`, `Run migrations in 'offline' mode.      This configures the context with just a U`, `Run migrations in 'online' mode.      In this scenario we need to create an Engi`, `Merge multiple heads  Revision ID: merge_heads_2026 Revises: 001_create_user_tab` (+8364 more)
...
- **Why does `next` connect `Community 167` to `Community 33`, `Community 98`, `Community 548`, `Community 5`, `Community 166`, `Community 154`, `Community 101`, `Community 73`, `Community 277`, `Community 54`, `Community 314`, `Community 93`, `Community 31`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `CircuitBreaker` connect `Community 102` to `Community 0`, `Community 129`, `Community 7`, `Community 139`, `Community 12`, `Community 13`, `Community 18`, `Community 146`, `Community 277`, `Community 152`, `Community 28`, `Community 540`, `Community 160`, `Community 55`, `Community 69`, `Community 328`, `Community 329`, `Community 333`, `Community 207`, `Community 91`, `Community 497`, `Community 505`, `Community 378`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `AutoCreator` connect `Community 13` to `Community 4`, `Community 197`, `Community 102`, `Community 7`, `Community 73`, `Community 587`, `Community 16`, `Community 17`?**
