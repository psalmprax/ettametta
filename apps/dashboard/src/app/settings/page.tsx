                ...
                <div className="flex-1 section-container relative py-16 px-8 lg:px-24 max-w-screen-2xl mx-auto w-full z-10">
                    ...
                    <header className="mb-20 flex flex-col xl:flex-row xl:items-end justify-between gap-12">
                        ...
                        <div className="flex items-center gap-6">
                            <Card variant="solid" className="p-6 flex flex-col items-end gap-1">
                                <span className="font-data-mono text-[8px] text-zinc-600 uppercase">Revision ID</span>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        <div className="lg:col-span-3 space-y-4">
                            {["Identity", "Security", "Network", "Billing", "Monetization", "Advanced"].map((tab) => (
                                <button
                                    key={tab}
                                    onClick={() => setActiveTab(tab)}
                                    className={cn(
                                        "w-full p-6 flex items-center justify-between border transition-all relative overflow-hidden",
                                        activeTab === tab 
                                ...
                                >
                                    <span className="font-label-caps text-[9px] tracking-widest uppercase">{tab}</span>
                                    <ChevronRight className={cn("h-3 w-3 transition-transform", activeTab === tab ? "translate-x-0 opacity-100" : "-translate-x-2 opacity-0")} />
                                </button>
                            ))}
                        </div>
                                ...
                                >
                                    ...
                                    <header className="mb-12 border-b border-white/5 pb-8 flex items-center justify-between">
                                        <div className="space-y-1">
                                            ...
                                            <p className="font-data-mono text-[8px] text-zinc-600 uppercase tracking-widest">Protocol Identity Handoff</p>
                                        </div>
                                        ...
                                        <div className="space-y-12">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <Card variant="solid" className="p-8">
                                                    <label className="font-label-caps text-[9px] text-zinc-600 uppercase tracking-wider">Network Alias</label>
                                                    <p className="text-2xl font-bold text-white  mt-2">Administrator</p>
                                                </Card>
                                                <Card variant="solid" className="p-8">
                                                    <label className="font-label-caps text-[9px] text-zinc-600 uppercase tracking-wider">Subscription Tier</label>
                                                    <p className="text-2xl font-bold text-indigo-400  mt-2">Sovereign</p>
                                                </Card>
                                            </div>
                                    ...
                                    {activeTab === "Security" && (
                                        <div className="space-y-12">
                                            <Card variant="solid" className="p-8 bg-indigo-500/5 border-indigo-500/20">
                                                ...
                                                <div className="grid grid-cols-1 gap-8 pt-6 border-t border-white/5">
                                                    {["groq_api_key", "elevenlabs_api_key", "pexels_api_key"].map((key) => (
                                                        <div key={key} className="space-y-2">
                                                            <label className="font-data-mono text-[9px] text-zinc-600 uppercase tracking-widest">
                                    ...
                                    {activeTab === "Billing" && (
                                        <div className="space-y-12">
                                            <Card variant="solid" className="p-10 bg-indigo-500/5 border-indigo-500/20 text-center space-y-6">
                                                ...
                                                <div className="space-y-1">
                                                    ...
                                                    <p className="font-data-mono text-[8px] text-zinc-600 uppercase tracking-widest">Active Subscription Found</p>
                                                </div>
                                                <div className="pt-6 border-t border-white/5">
                                                    <Button variant="primary" size="md" className=" tracking-tighter">
                                                        Manage Payment Nodes
                                                    </Button>
                                                </div>
                                            </Card>
                                        </div>
                                    ...
                                    {["Network", "Monetization", "Advanced"].includes(activeTab) && (
                                        <div className="h-full flex flex-col items-center justify-center opacity-30 space-y-6 grayscale">
                                            ...
                                            <p className="font-data-mono text-[9px] uppercase tracking-[0.5em] font-bold">Segment Locked v3.2</p>
                                        </div>
                                    )}
                                </motion.div>
                            </AnimatePresence>
