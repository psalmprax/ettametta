                                ...
                                >
                                    ...
                                    <header className="mb-12 border-b border-white/5 pb-8 flex items-center justify-between">
                                        <div className="space-y-1">
                                            <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase">{activeTab} Terminal</h2>
                                        ...
                                        <div className="space-y-12">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div className="p-8 bg-white/2 border border-white/5 space-y-4 group hover:border-indigo-500/20 transition-all">
                                                    ...
                                                    <p className="text-2xl font-black text-white italic">Administrator</p>
                                                </div>
                                                <div className="p-8 bg-white/2 border border-white/5 space-y-4 group hover:border-indigo-500/20 transition-all">
                                                    <label className="font-label-caps text-[9px] text-zinc-600 uppercase tracking-widest">Subscription_Tier</label>
                                                    <p className="text-2xl font-black text-indigo-400 italic">SOVEREIGN</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="space-y-12">
                                            <div className="p-8 bg-indigo-500/5 border border-indigo-500/20 space-y-6">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <h3 className="text-xl font-black text-white italic tracking-tighter uppercase">API Overrides</h3>
                                                </div>
                                                        ...
                                                        <div key={key.id} className="space-y-2">
                                                            ...
                                                            <div className="relative">
                                                                <input
                                                                    ...
                                                                    className="w-full bg-zinc-950 border border-white/5 p-4 text-white font-black text-sm focus:border-indigo-500/50 outline-none pr-12 transition-all"
                                                                />
                                                                <button
                                                                    type="button"
                                    ...
                                    {activeTab === "Billing" && (
                                        <div className="space-y-12">
                                            <div className="surface-glass rim-light p-10 bg-indigo-500/5 border-indigo-500/20 text-center space-y-6">
                                                ...
                                                <div className="space-y-1">
                                                    <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase">Empire Access</h3>
                                                    <p className="font-data-mono text-[8px] text-zinc-600 uppercase tracking-widest">Active_Subscription_Found</p>
                                                </div>
                                                <div className="pt-6 border-t border-white/5">
                                                    <button className="action-primary py-4 px-10 italic text-[10px] tracking-tighter">
                                    ...
                                    {["Network", "Monetization", "Advanced"].includes(activeTab) && (
                                        <div className="h-full flex flex-col items-center justify-center opacity-30 space-y-6 grayscale">
                                            ...
                                            <p className="font-data-mono text-[9px] uppercase tracking-[0.5em] font-black">Segment_Locked_v3.2</p>
                                        </div>
                                    )}
                                </motion.div>
                            </AnimatePresence>
