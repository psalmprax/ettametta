                    ...
                    <header className="mb-20 flex flex-col xl:flex-row xl:items-end justify-between gap-12">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <h1 className="text-6xl md:text-8xl font-black text-white uppercase tracking-tighter leading-none glitch-text italic" data-text="INTEL_CORE">
                                    Intel Core
                                </h1>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <button className="action-primary h-20 px-12 italic text-xs tracking-tighter">
                                EXPORT_DATA_PACK
                            </button>
                        </div>
                    </header>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-12">
                        ...
                        <div className="xl:col-span-8 surface-glass rim-light p-10 space-y-10 relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-between border-b border-white/5 pb-8">
                                <div className="space-y-2">
                                    <h3 className="text-2xl font-black text-white uppercase tracking-tighter italic">Retention Spectrum</h3>
                                                ...
                                                if (active && payload && payload.length) {
                                                    return (
                                                        <div className="surface-glass rim-light p-6 backdrop-blur-3xl shadow-2xl space-y-2">
                                                            ...
                                                            <p className="text-3xl font-black text-white italic tracking-tighter">{payload[0].value}%</p>
                        ...
                        <div className="xl:col-span-4 space-y-12">
                            <section className="surface-glass rim-light p-10 space-y-8 relative group overflow-hidden">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <button className="w-full action-primary py-5 italic text-[10px] tracking-tighter">
                                        RE-OPTIMIZE_SEGMENT
                                    </button>
                                </div>
                            </section>
                            ...
                            <section className="surface-glass rim-light p-10 space-y-10">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-white font-black italic">0.024</span>
                                    </div>
                    ...
                    <div className="mt-12 grid grid-cols-1 xl:grid-cols-2 gap-12">
                        <div className="surface-glass rim-light p-10 h-96 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 space-y-2">
                                <h3 className="text-xl font-black text-white italic tracking-tighter">Global Propagation</h3>
                        ...
                        <div className="surface-glass rim-light p-10 space-y-8">
                             <div className="flex items-center justify-between">
                                <h3 className="text-xl font-black text-white italic tracking-tighter">Viral Matrix</h3>
