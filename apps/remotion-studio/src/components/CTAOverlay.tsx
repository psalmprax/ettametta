        ...
        <AbsoluteFill style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#FF0000' }}>
                        ...
                        <span style={{ color: 'white', fontSize: '24px', fontWeight: 700 }}>LIKE</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#00D4FF' }}>
                        ...
                        <span style={{ color: 'white', fontSize: '24px', fontWeight: 700 }}>SUBSCRIBE</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#FFD700' }}>
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.89 2 2 2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z"/></svg>
                        <span style={{ color: 'white', fontSize: '24px', fontWeight: 700 }}>NOTIFY</span>
                    </div>
                </div>
