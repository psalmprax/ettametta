...
class KaiberSkill(OpenClawBaseSkill):
    ...
    async def generate(self, prompt: str, aspect_ratio: str = "16:9") -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"[Kaiber] Generating video: {prompt[:50]}...")
            ...
            logger.info("[Kaiber] Generation submitted, waiting for render...")

            await self.page.wait_for_selector(
                "video, [class*='video'], [class*='preview']", timeout=120000
            )
