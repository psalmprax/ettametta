...
- Name: user/user_management.spec.ts >> User Management - Register >> should register new user
- Location: tests/user/user_management.spec.ts:15:9
...
Call log:
  - waiting for locator('input[name="username"]')
    3 × waiting for" http://localhost:3000/register" navigation to finish...
