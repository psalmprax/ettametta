...
- Name: creation/video_generation.spec.ts >> Video Generation - AI Generate from Text >> should generate video with LTX-Video engine
- Location: tests/creation/video_generation.spec.ts:72:9
