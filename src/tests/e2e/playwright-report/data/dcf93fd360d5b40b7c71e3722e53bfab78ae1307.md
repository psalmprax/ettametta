...
- Name: creation/video_generation.spec.ts >> Video Generation - AI Generate from Text >> should generate video with Lite4K engine
- Location: tests/creation/video_generation.spec.ts:61:9
