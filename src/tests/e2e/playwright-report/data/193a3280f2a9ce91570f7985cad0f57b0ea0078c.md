...
- Name: billing/billing.spec.ts >> Billing - Webhook Handling >> should handle subscription update webhook
- Location: tests/billing/billing.spec.ts:104:9
...
Locator: locator('[data-testid="webhook-log"]')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="webhook-log"]')
    - waiting for" http://localhost:3000/webhooks/stripe" navigation to finish...
