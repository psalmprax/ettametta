...
- Name: real_first_hardening.spec.ts >> Real-First Hardening Verification >> Admin: Environment synchronization must use real backend signals
- Location: tests/real_first_hardening.spec.ts:79:7
