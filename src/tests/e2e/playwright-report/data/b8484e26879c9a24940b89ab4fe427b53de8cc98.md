...
- Name: admin/admin_operations.spec.ts >> Admin Operations - System Monitoring >> should display system metrics
- Location: tests/admin/admin_operations.spec.ts:62:9
