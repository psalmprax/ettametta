...
- Name: real_first_hardening.spec.ts >> Real-First Hardening Verification >> Empire: Velocity and Scale must be deterministic
- Location: tests/real_first_hardening.spec.ts:52:7
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    3 × navigated to "http://localhost:3000/login"
      - waiting for" http://localhost:3000/login" navigation to finish...
    - navigated to "http://localhost:3000/login"
