...
- Name: billing/billing.spec.ts >> Billing - Webhook Handling >> should handle payment failure webhook
- Location: tests/billing/billing.spec.ts:109:9
...
Locator: locator('[data-testid="webhook-status"]')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="webhook-status"]')
    2 × waiting for" http://localhost:3000/webhooks/stripe" navigation to finish...
      - navigated to "http://localhost:3000/webhooks/stripe"
