...
- Name: user/user_management.spec.ts >> User Management - Login >> should display login form
- Location: tests/user/user_management.spec.ts:61:9
...
Call log:
  ...
  - waiting for locator('h1')
    2 × waiting for" http://localhost:3000/login" navigation to finish...
      ...
      - locator resolved to <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-slate-900">Sign In</h1>
      ...
      - locator resolved to <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-slate-900">Sign In</h1>
      - unexpected value "Sign In"
    6 × locator resolved to <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-slate-900">Sign In</h1>
      - unexpected value "Sign In"
