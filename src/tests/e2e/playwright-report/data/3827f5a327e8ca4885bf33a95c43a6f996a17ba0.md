...
- Name: autonomous/simple_autonomous_test.spec.ts >> Simple Autonomous Operations Test >> should login and navigate to autonomous page
- Location: tests/autonomous/simple_autonomous_test.spec.ts:4:9
...
Locator: locator('h1:text("ETTAMETTA")')
Expected: visible
Timeout: 30000ms
...
Call log:
  ...
  - waiting for locator('h1:text("ETTAMETTA")')
    3 × waiting for" http://127.0.0.1:3000/login" navigation to finish...
