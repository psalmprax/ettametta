...
- Name: user/user_management.spec.ts >> User Management - Register >> should validate password strength
- Location: tests/user/user_management.spec.ts:32:9
...
Call log:
  - waiting for locator('input[name="username"]')
    2 × waiting for" http://localhost:3000/register" navigation to finish...
