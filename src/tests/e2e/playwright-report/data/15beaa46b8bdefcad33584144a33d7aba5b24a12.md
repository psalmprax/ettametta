...
- Name: discovery/discovery.spec.ts >> Content Discovery >> should display publishing page
- Location: tests/discovery/discovery.spec.ts:24:9
...
Call log:
  - navigating to "http://localhost:3000/publishing", waiting until "load"
