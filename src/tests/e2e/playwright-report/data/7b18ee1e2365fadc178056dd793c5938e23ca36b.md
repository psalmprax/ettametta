...
- Name: creation/video_generation.spec.ts >> Video Generation - AI Generate from Text >> should validate prompt is not empty
- Location: tests/creation/video_generation.spec.ts:102:9
