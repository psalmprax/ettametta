...
- Name: creation/video_generation.spec.ts >> Video Generation - AI Generate from Text >> should display AI generation interface
- Location: tests/creation/video_generation.spec.ts:54:9
