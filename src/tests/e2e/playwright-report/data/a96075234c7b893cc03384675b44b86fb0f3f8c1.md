...
- Name: creation/video_generation.spec.ts >> Video Generation - AI Generate from Text >> should generate video with HunyuanVideo engine
- Location: tests/creation/video_generation.spec.ts:83:9
