...
- Name: autonomous/agent_zero_autonomous.spec.ts >> Step 4: Autonomous Operations - Agent Zero & Nexus Flow >> should launch Agent Zero and verify autonomous execution states
- Location: tests/autonomous/agent_zero_autonomous.spec.ts:29:9
