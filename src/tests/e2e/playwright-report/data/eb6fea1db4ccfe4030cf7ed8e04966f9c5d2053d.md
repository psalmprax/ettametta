...
- Name: agent_skills_e2e.spec.ts >> Agent Skills E2E - Universal Integration >> should verify Paperclip KPI tracking performance
- Location: tests/agent_skills_e2e.spec.ts:68:9
