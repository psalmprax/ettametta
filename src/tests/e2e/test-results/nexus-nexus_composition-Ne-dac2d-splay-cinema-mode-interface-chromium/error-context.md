...
- Name: nexus/nexus_composition.spec.ts >> Nexus Composition - Cinema Mode >> should display cinema mode interface
- Location: tests/nexus/nexus_composition.spec.ts:64:9
