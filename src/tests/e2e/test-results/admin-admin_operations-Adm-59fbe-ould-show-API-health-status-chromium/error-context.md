...
- Name: admin/admin_operations.spec.ts >> Admin Operations - System Monitoring >> should show API health status
- Location: tests/admin/admin_operations.spec.ts:67:9
