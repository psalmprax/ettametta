...
- Name: creation/video_models.spec.ts >> Video Model - Dashboard UI Tests >> should display transformation page
- Location: tests/creation/video_models.spec.ts:152:9
...
Call log:
  - navigating to "http://localhost:3000/transformation", waiting until "load"
