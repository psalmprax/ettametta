...
- Name: creation/video_models.spec.ts >> Video Model - Dashboard UI Tests >> should display nexus page
- Location: tests/creation/video_models.spec.ts:162:9
...
Call log:
  - navigating to "http://localhost:3000/nexus", waiting until "load"
