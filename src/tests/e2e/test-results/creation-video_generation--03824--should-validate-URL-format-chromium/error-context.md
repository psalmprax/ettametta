...
- Name: creation/video_generation.spec.ts >> Video Generation - Transform Existing Video >> should validate URL format
- Location: tests/creation/video_generation.spec.ts:36:9
