...
- Name: creation/video_creation.spec.ts >> Video Processing Jobs >> should cancel job
- Location: tests/creation/video_creation.spec.ts:153:9
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    4 × navigated to "http://localhost:3000/login"
