...
- Name: real_first_hardening.spec.ts >> Real-First Hardening Verification >> Settings: Communications verification must be operational
- Location: tests/real_first_hardening.spec.ts:64:7
