...
- Name: real_first_hardening.spec.ts >> Real-First Hardening Verification >> Video Preview: Should handle dynamic status metadata
- Location: tests/real_first_hardening.spec.ts:90:7
