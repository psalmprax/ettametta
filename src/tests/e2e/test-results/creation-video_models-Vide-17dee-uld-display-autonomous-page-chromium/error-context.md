...
- Name: creation/video_models.spec.ts >> Video Model - Dashboard UI Tests >> should display autonomous page
- Location: tests/creation/video_models.spec.ts:157:9
...
Call log:
  - navigating to "http://localhost:3000/autonomous", waiting until "load"
