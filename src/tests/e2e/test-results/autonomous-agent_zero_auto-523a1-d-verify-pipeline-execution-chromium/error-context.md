...
- Name: autonomous/agent_zero_autonomous.spec.ts >> Step 4: Autonomous Operations - Agent Zero & Nexus Flow >> should trigger Nexus Flow composition and verify pipeline execution
- Location: tests/autonomous/agent_zero_autonomous.spec.ts:73:9
