...
- Name: visual_regression.spec.ts >> Mobile Visual Regression >> Mobile dashboard visual regression
- Location: tests/visual_regression.spec.ts:77:7
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    7 × navigated to "http://localhost:3000/login"
