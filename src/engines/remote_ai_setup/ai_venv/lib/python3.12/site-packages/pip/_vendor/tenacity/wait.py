...
class wait_base(abc.ABC):
    ...
    def __radd__(self, other: "wait_base") -> typing."wait_combine" | "wait_base":
...
WaitBaseT = typing.Union[wait_base, typing.Callable[["RetryCallState"], typing.float | int]]
...
class wait_exponential(wait_base):
    ...
    def __init__(
        self,
        multiplier: typing.int | float = 1,
        max: _utils.time_unit_type = _utils.MAX_WAIT,  # noqa
        exp_base: typing.int | float = 2,
