...
class Syntax(JupyterMixin):
    ...
    Args:
        ...
        background_color (str, optional): Any background color, or None to use theme color. Defaults to None.
    ...
    def guess_lexer(cls, path: str, code: str | None = None) -> str:
        ...
        Args:
             ...
             code (str, optional): Any string of code that will be used as a fallback if no lexer
    ...
    def highlight(
        ...
        Args:
            code (str): Code to highlight.
            line_range(tuple[int, int], optional): Any line range to highlight.
