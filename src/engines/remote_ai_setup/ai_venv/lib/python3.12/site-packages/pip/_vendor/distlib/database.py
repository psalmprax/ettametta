...
class Distribution(object):
    ...
    def source_uri(self):
        ...
        """
        return self.metadata.source_uri

    download_url = source_uri  # Backward compatibility
    ...
    def __hash__(self):
        ...
        """
        return hash(self.name) + hash(self.version) + hash(self.source_uri)
