...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        forward references encoded as string literals, adds t | None if a
...
# 3.7-3.9
    ...
    def get_args(tp):
        ...
        Examples::
            ...
            get_args(int) == ()
            get_args(Union[int, T | int, str][int]) == (int, str)
...
class _SpecialForm(typing._Final, _root=True):
    ...
    def __or__(self, other):
        return typing.self | other

    def __ror__(self, other):
        return typing.other | self
...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        __msg: str,
        *,
        category: typing.typing.Type[Warning] | None = DeprecationWarning,
        stacklevel: int = 1,
        ...
        if sys.version_info >= (3, 10):
            def __or__(self, right):
                ...
                if not _is_unionable(right):
                    return NotImplemented
                return typing.self | right

            def __ror__(self, left):
                if not _is_unionable(left):
                    return NotImplemented
                return typing.left | self
