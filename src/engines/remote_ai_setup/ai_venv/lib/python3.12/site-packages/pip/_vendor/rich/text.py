...
class Text(JupyterMixin):
    ...
    def highlight_regex(
        ...
        *,
        ...
        Args:
            ...
            style (GetStyleCallable | StyleType): Any style to apply to whole match, or a callable
                which accepts the matched text and returns a style. Defaults to None.
            style_prefix (str, optional): Any prefix to add to style group names.
    ...
    def render(self, console: "Console", end: str = "") -> Iterable["Segment"]:
        ...
        Args:
            ...
            end (str | None, optional): Any end character.
    ...
    def append_tokens(
        ...
        Args:
            pairs (Iterable[tuple[str, StyleType | None]]): An iterable of tuples containing str content and style.
